...
# si le player1 ou le player2 pour check si il a gagner
...
# pour donner un color une fois l'utilisateur à gagner
...
#### pour afficher x ou o dans la parti on a cliques
def empty_spaces():
...
####### si on click sur le button restar et enrecomence le jeu avec le changemen de text
